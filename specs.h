//Physically relevant
#define ncoll 1000000			// Max # of collisions
#define tmax 50.0			// Max rescaled time (whichever smallest)
#define dim 2			// Dimension of space
#define rdens 0.05			// Reduced density
...
#define alpha 0.6			// Restitution coefficient for inelastic collisions


//Precision and averaging
#define nu 120000			// Total particle number
...
#define partinit .05		// Initial energetic particles (if >1: nb of particles, if <1: radius/width)
...
#define printpas 20000			// # of collisions b/w full output  (position and velocity for all particles if nsys<nslim)
